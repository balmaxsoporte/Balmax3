...
class AgregarUsuarioDialogFragment : DialogFragment() {
    ...
    companion object {
        fun newInstance(onUsuarioCreado: (nombre: String, contrasena: String, permisos: String) -> Unit): AgregarUsuarioDialogFragment {
            ...
            fragment.onUsuarioCreado = onUsuarioCreado
            return fragment
        }
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val etNombreUsuario = view.findViewById<TextInputLayout>(R.id.et_nombre_usuario)
        val etContrasena = view.findViewById<TextInputLayout>(R.id.et_contrasena)
        val etPermisos = view.findViewById<TextInputLayout>(R.id.et_permisos)
